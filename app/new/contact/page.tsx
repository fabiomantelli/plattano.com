...
export default function ContactPage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative py-20 md:py-32 bg-gradient-to-br from-primary-600 to-secondary-600 text-white overflow-hidden">
                ...
                <CardContent className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">info@plattano.com</p>
                    </div>
                  </a>
