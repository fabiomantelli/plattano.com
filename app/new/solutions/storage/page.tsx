...
export default function StoragePage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative py-20 md:py-32 bg-gradient-to-br from-purple-600 to-indigo-600 text-white overflow-hidden">
              ...
              <CardContent className="pt-6">
                ...
                <ul className="space-y-2 mb-6">
                  {plattanoHot.idealFor.map((item, idx) => (
                    <li key={idx} className="flex items-start text-sm">
                      <CheckCircle className="h-4 w-4 text-indigo-600 mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">{item}</span>
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-20 bg-gradient-to-br from-purple-100 to-indigo-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <TrendingDown className="h-16 w-16 text-purple-600 mx-auto mb-6" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {caseStudies.map((study, index) => (
              <Card key={index}>
                <CardHeader>
                  <CardTitle className="text-purple-600">{study.industry}</CardTitle>
                </CardHeader>
