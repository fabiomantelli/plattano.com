...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[65vh] flex items-center justify-center overflow-hidden bg-white text-neutral-800 sm:bg-gradient-to-b sm:from-gray-50 sm:to-white dark:bg-black dark:text-white sm:dark:bg-gradient-to-b sm:dark:from-gray-900 sm:dark:to-black">
      ...
      >
        <h1
          className={`
            ...
            drop-shadow-[0_0_1px_rgba(237,110,0,0.8)]
          `}
        >
