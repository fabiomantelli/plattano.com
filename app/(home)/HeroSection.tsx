...
export default function HeroSection() {
  ...
  if (!mounted) {
    return (
      <section className="relative w-full h-[65vh] flex items-center justify-center overflow-hidden bg-neutral-50 text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
        {/* Grid watermark */}
        <div
        ...
        {/* Content - Static version for SSR */}
        <div className="relative z-10 mx-auto max-w-4xl text-center px-6">
          <h1 className="font-sofia font-bold leading-tight hero-title text-3xl sm:text-4xl lg:text-5xl opacity-100">
  ...
  return (
    <section className="relative w-full h-[65vh] flex items-center justify-center overflow-hidden bg-white text-neutral-800 dark:bg-black dark:text-white">
      ...
      {!isMobile && (
        <>
          <Image
            src={resolvedTheme === 'dark' ? '/images/home/high-tech-background-dark.png' : '/images/home/high-tech-background-light.png'}
