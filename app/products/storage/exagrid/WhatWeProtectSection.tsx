...
export default function WhatWeProtectSection() {
  ...
  return (
    <section className="w-full py-20 bg-background">
      <div className={`max-w-6xl mx-auto px-6 sm:px-12 lg:px-24 text-center ${textColor}`}>
        <motion.h2
        ...
        <div className="max-w-4xl mx-auto cursor-pointer" onClick={() => openModal('/images/products/storage/exagrid/exagrid-app-protect.webp')}>
          <Image
