...
const MODES = [
  {
    ...
    subtitle:
      'A standalone solution to back up and restore AWS workloads within AWS only.',
...
export default function VeeamAwsBackupComparisonSection() {
  return (
    <section className="w-full py-20 bg-white text-neutral-900 dark:bg-black dark:text-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-12 lg:px-24 space-y-8">
        ...
        >
          Compare AWS-only vs. Integrated Modes
        </motion.h2>
