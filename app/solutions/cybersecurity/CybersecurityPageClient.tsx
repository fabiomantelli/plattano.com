...
export default function CybersecurityPageClient() {
  ...
  const sentinelOneServiceSchema = generateServiceSchema(
    'SentinelOne Endpoint Protection',
    sentinelOne.description,
    'Endpoint Protection Service'
  )
  const rainforestServiceSchema = generateServiceSchema(
    'Rainforest Brand Protection',
  ...
  return (
    <>
      <StructuredData data={[faqSchema, sentinelOneServiceSchema, rainforestServiceSchema]} />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 text-white text-center">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-semibold">
                SentinelOne Certified Partner G�� AI-Powered Endpoint Protection Leader
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 text-white text-center">
            <div className="flex items-center gap-2">
              <Shield className="h-4 w-4" />
              <p className="text-sm font-semibold">
                Rainforest Partner G�� External Attack Surface Management Specialist
              </p>
            </div>
          </div>
        </div>
