...
export default function SolutionsSection() {
  ...
  return (
    <section className={`w-full ${isDark ? 'bg-neutral-900 text-white' : 'bg-white text-neutral-900'}`}>
      <div className="mx-auto max-w-7xl gap-16 py-24 px-8 sm:px-12 lg:px-24">
        {/* Título Centralizado */}
        ...
        <div className="flex flex-col md:flex-row items-center gap-32 mb-24">
          ...
          >
            ...
            <p className="text-[18px]">
              And navigate your way out of problems.
            </p>
            <Link
              href="#"
              className="
                inline-block px-8 py-3 rounded-md font-semibold shadow-lg transition-colors duration-200
