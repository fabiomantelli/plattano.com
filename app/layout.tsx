...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Plattano Technologies',
    description: 'Plattano Technologies, based in Orlando, Florida, specializes in tailored IT services, including data protection, hybrid cloud infrastructure, and cybersecurity.',
    url: 'https://plattano.com',
    siteName: 'Plattano Technologies',
    images: [
      {
        url: 'https://plattano.com/images/home/apple-touch-icon.png',
        width: 180,
        height: 180,
        alt: 'Plattano Technologies Logo',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Plattano Technologies',
    description: 'Plattano Technologies, based in Orlando, Florida, specializes in tailored IT services, including data protection, hybrid cloud infrastructure, and cybersecurity.',
    images: ['https://plattano.com/images/home/apple-touch-icon.png'],
  },
  robots: {
    index: true,
    follow: true,
